...
class parser_bloggers extends Model
{
    ...
    * @var string
    */
    protected $table = 'parser_bloggers';
    ...
    */
     ...
     * @var array
     */
    protected $fillable = ['name','surname','patronymic','birthday','nickname','phone','email','instagram_account','telegram_account','tag'];
