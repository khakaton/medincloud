...
class report_bloger extends Model
{
    ...
    * @var string
    */
    protected $table = 'report_blogers';
    ...
    */
     ...
     * @var array
     */
    protected $fillable = ['bloger_id','platform_id','link','views','likes','scores','comment'];
     ...
     * @var array
     */
    protected $altrp_with = ['bloger','platform'];
    ...
    {
        return $this->belongsTo('App\AltrpModels\platform', 'platform_id', 'id');
    }
